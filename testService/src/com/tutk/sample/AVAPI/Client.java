...
import com.zhutieju.testservice.MainActivity;
    ...
    public static class VideoThread implements Runnable {
        ...
        public void run() {
            ...
            while (true) {
                ...
                if(ret>=1){
                	byte[] data = new byte[ret-1];
                    
                    System.arraycopy(videoBuffer,  
                            0,
                            data, 
                            0,
                            ret-1);
                    Log.e("video", "data.lenght = "+data.length);
                    
                    MainActivity.mainActivity.setOrget(1, data);
                }
